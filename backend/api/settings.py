...
ALLOWED_HOSTS = os.getenv('ALLOWED_HOSTS', 'localhost,127.0.0.1,0.0.0.0,testserver,backend').split(',')
...
MIDDLEWARE = [
    ...
    'core.middleware.APIResponseMiddleware',  # Custom middleware for APIResponse handling
]
