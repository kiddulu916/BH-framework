...
Revision ID: 7a388a2b74a6
Revises: 
Create Date: 2025-07-28 17:21:11.081292
...
def upgrade() -> None:
    ...
    sa.Column('status', sa.Enum('ACTIVE', 'INACTIVE', name='targetstatus'), nullable=False),
    ...
    sa.Column('researcher_email', sa.String(length=255), nullable=True),
    ...
    op.create_index('idx_targets_domain', 'targets', ['domain'], unique=False, schema='public')
    ...
    op.create_index(op.f('ix_public_targets_domain'), 'targets', ['domain'], unique=False, schema='public')
    op.create_index(op.f('ix_public_targets_id'), 'targets', ['id'], unique=False, schema='public')
    op.create_index(op.f('ix_public_targets_target'), 'targets', ['target'], unique=False, schema='public')
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_public_targets_target'), table_name='targets', schema='public')
    op.drop_index(op.f('ix_public_targets_id'), table_name='targets', schema='public')
    op.drop_index(op.f('ix_public_targets_domain'), table_name='targets', schema='public')
    ...
    op.drop_index('idx_targets_domain', table_name='targets', schema='public')
